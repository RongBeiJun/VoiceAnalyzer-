...
public class CustomYAxisRendererLeft extends YAxisRenderer {
    public CustomYAxisRendererLeft(ViewPortHandler viewPortHandler, YAxis yAxis, Transformer trans) {
